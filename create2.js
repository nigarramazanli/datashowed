document.addEventListener("DOMContentLoaded", function () {
    ...
    const emlakTypeField=createField('Əmlakın Tipi','emlakinTipiSelect',[1,2,3,4,5,6,7,13]);
    const emlakinSenediField=createField('Əmlakın Sənədi', 'emlakinSenediSelect', [1,2,3,4,5]);
    ...
    const menbeField= createField('Mənbə','menbelSelect',["Bina.az","Emlak.az","Real Əmlak"]);
    ...
    const deaktiveField=createField('Deaktiv', 'deaktuveSelect',["Var","Yoxdur"]);
    
    function appendField(container, labelText, field) {
        const fieldLabel = document.createElement('label');
        fieldLabel.textContent = labelText + ': ';
        container.appendChild(fieldLabel);

        container.appendChild(field.select); // Select dropdown
        container.appendChild(field.valueSpan); // Span for selected value
        container.appendChild(document.createElement('br')); // Line break
    }

    // Append fields to leftContainer
    appendField(leftContainer, 'Ərazi', eraziField);
    appendField(leftContainer, 'Layihə', layiheField);
    appendField(leftContainer, 'Mtk', mtkField);
    appendField(leftContainer, 'Layihə Təyinatı', layiheTeyinatiField);
    appendField(leftContainer, 'Əmlakın Sənədi',  emlakinSenediField);
    appendField(leftContainer, 'Otaq Sayı', otaqSayiField);
    appendField(leftContainer, 'Otaq Dəyişdirilib', otaqDeyisdirilibField);
    appendField(leftContainer, 'Təmir', temirField);
    appendField(leftContainer, 'Təmir Tipi', temirTypeField);
    appendField(leftContainer, 'Ümumi Mərtəbə', umumiMertebeField);
    appendField(leftContainer, 'Mərtəbə', mertebeField);
    appendField(leftContainer, ' Ev Əşyaları', evEsyalariField);

    appendField(leftContainer, 'Gas', gasField);
    appendField(leftContainer, 'Qaraj', qarajField);
    appendField(leftContainer, 'Mənbə', menbeField);
    appendField(leftContainer, 'Qiymət', qiymetField);
    appendField(leftContainer, 'Qeyd', noteField);
    appendField(leftContainer, 'Servis Haqqı', serviceField);
    appendField(leftContainer, 'Qeydin Silinmə Səbəbi', deleteReasonNoteField);
    



    // Append fields to rightContainer
    appendField(rightContainer, 'Torpaq Sahəsi', torpaqSahesiField);
    appendField(rightContainer, 'Sahə', saheField);
    appendField(rightContainer, 'Yaranma Tarixi', createdDateField);
    appendField(rightContainer, 'Yenilənmə Tarixi', updateDateField);
    appendField(rightContainer, 'Silinmə Tarixi', deleteDateField);
    appendField(rightContainer, 'Hissə-Hissə ödəmə', partialPayField);

    appendField(rightContainer, 'Kredit Mövcudluğu', creditExistField);
    appendField(rightContainer, 'Kredit Müddəti', creditDateField);
    appendField(rightContainer, 'Kredit Id', creditIdField);
    appendField(rightContainer, 'Aylıq Ödəniş', ayliqOdenisField);
    appendField(rightContainer, 'Ilkin ödəniş', ilkinOdenisField);
    appendField(rightContainer, 'Yenilənən User İd', upDateUserIdField);
    appendField(rightContainer, 'Deaktiv', deaktiveField);
    appendField(rightContainer, 'Eksluziv Olması', isEcslusiveField);
    appendField(rightContainer, 'Sayt Adı', saytAdiField);
    appendField(rightContainer, 'Sayt Id', saytIdField);
    appendField(rightContainer, 'Agent', agentField);
    appendField(rightContainer, 'Filial', filialField);
        ...
        .then(data => {
            ...
            row.appendChild(branchIdCell);
                ...
                const fields = [
                    ...
                    { select: emlakinSenediField.select, valueSpan : emlakinSenediField,userProperty: 'emlakSenedId'},
